...
hbasewinAttr *Createsignpage(hbasewinAttr *parent, int winID)
{
  ...
  CreateTextBox(page, 610, 95, 80, 26, ID_SIGNIN_SEX, "男", 1);
  CreateTextBox(page, 240, 166, 80, 26, ID_SIGNIN_MARRIAGESTATUS, "未婚", 1);
  ...
  CreateTextBox(page, 610, 297, 150, 26, ID_SIGNIN_ALLERGY, "无", 1);
